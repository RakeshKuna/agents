...
class EnhancedTable extends React.Component {
    ...
    handleDetailView = (e, id) => {
        ...
        e.stopPropagation();
        this.props.history.push( `/agentprofiles/${this.props.props.match.params.agentid}/branches/${this.props.match.params.agentbranchId}/ratechargepreference/${id}`)
    }
    ...
    handleEdit = (e, id) => {
        ...
        this.props.history.push({
            pathname: `/agentprofiles/${this.props.props.match.params.agentid}/branches/${this.props.match.params.agentbranchId}/editRateChargePreference/${id}`
        })
    }
                            ...
                            {this.props.bankList && this.props.bankList['data'] && this.props.bankList['data'].map((row, index) => {
                                return (
                                    ...
                                    >
                                        ...
                                        <TableCell>{row.rateCharge}</TableCell>
