...
class EnhancedTable extends React.Component {
    ...
    handleEdit = (e, id) => {
        ...
        this.props.history.push({
            pathname: `/agentprofiles/${this.props.match.params.agentid}/branches/${this.props.match.params.agentbranchId}/editChargeRules/${id}`
        })
    }
    ...
    handleViewDetail(id, e) {
        e.stopPropagation();
        this.props.history.push({
            pathname: `/agentprofiles/${this.props.match.params.agentid}/branches/${this.props.match.params.agentbranchId}/viewChargeRules/${id}`
        })
    }
            ...
            <Paper className={classes.root}>
                <div>
                    <Table className='global-font' style={{ whiteSpace: `nowrap` }}>
                        ...
                        <TableBody>
                            {this.props.chargeRulesList.map((row, index) => {
                                return (
                                    <TableRow key={row.id}
                                        hover
                                    ...
                                    >
                                        ...
                                        <TableCell style={{ paddingLeft: 40 }}>{row.productType}</TableCell>
